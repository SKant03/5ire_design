    ...
    <div className="flex justify-center items-center my-28">
      <div class="card px-12">
        <div className="text-white flex flex-col gap-20">
          <p className="text-center text-8xl font-semibold">#BuildToEarn</p>
          <div className="flex">
            <div className="flex flex-col gap-10 text-3xl">
              ...
              <li>
                Reduced gas fees for early adopters and the first 500 builders
                to receive a share of block rewards.
              </li>
            </div>
            <div>
