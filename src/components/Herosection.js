            ...
            <div className="text-3xl text-white flex items-center justify-between w-5/6 top-0 mx-6">
              <div className="flex">
                ...
                <div className="bg-gradient-to-l from-[#457387] to-[#10171B] p-4 rounded-xl text-xl w-max my-p">
                    <DropdownItem className="py-4 mx-4">About 5ire</DropdownItem>
                    <DropdownItem className="py-4 mx-4">Team</DropdownItem>
                    <DropdownItem className="py-4 mx-4">Blog</DropdownItem>
                    <DropdownItem className="py-4 mx-4">Road to Manifest</DropdownItem>
                    <DropdownItem className="py-4 mx-4">News & Media</DropdownItem>
                  </div>
                </Dropdown>
              </div>
              <div className="flex">
                <Dropdown title="Testnet" className="absolute bg-transparent ">
                  <div className="bg-gradient-to-l from-[#457387] to-[#10171B] p-4 rounded-xl text-xl
                  w-max my-4 absolute z-50">
                    <DropdownItem className="py-4 mx-4">Testnet</DropdownItem>
                    <DropdownItem className="py-4 mx-4">Build To Earn</DropdownItem>
                    <DropdownItem className="py-4 mx-4">Documentaion</DropdownItem>
                  </div>
                </Dropdown>
              </div>
              <div>
                <Dropdown title="Community" className="absolute bg-transparent">
                  ...
                  <DropdownItem className="py-4 mx-4">5ire Ambassdor</DropdownItem>
                  <DropdownItem className="py-4 mx-4">Partner with Us</DropdownItem>
                  </div>
                </Dropdown>
              </div>
              <div>
                <Dropdown title="Research" className="absolute bg-transparent">
                  <div className="bg-gradient-to-l from-[#457387] to-[#10171B] p-4 rounded-xl text-xl w-max my-4 absolute z-50">
                  <DropdownItem className="py-4 mx-4">Reasearch Papers</DropdownItem>
                  <DropdownItem className="py-4 mx-4">Yellow paper</DropdownItem>
                  <DropdownItem className="py-4 mx-4">White paper</DropdownItem>
                  </div>
                </Dropdown>
              </div>
              <div>
                ...
                <div className="bg-gradient-to-l from-[#457387] to-[#10171B] p-4 rounded-xl text-xl w-max my-4">
                  <DropdownItem className="py-4 mx-4">Become a Validator</DropdownItem>
                  </div>
                </Dropdown>
              </div>
              <div>
                <NavLink to="/sustainablity" className="absolute">Sustainablity</NavLink>
                
              </div>
              <div className="relative top-4">
                <NavLink to="/5ire Explorer" className="bg-[#01FFA4] px-8 mx-6 text-xl h-[50px] font-semibold flex justify-end items-center rounded-full text-black">
                  5ire Explorer
                </NavLink>
              </div>
            </div>
